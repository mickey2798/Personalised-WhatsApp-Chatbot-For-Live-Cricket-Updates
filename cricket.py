...
class ScoreGet:
    def __init__(self):
        ...
        self.api_key = "piZXm9Ap2wghL1Rr74hYwQ8ZmKl2"
...
if __name__ == "__main__":
    ...
    account_sid = "AC3813988282c6cbba1fc462aa0b40efa6"
    auth_token = "ee2b6283db1f1b2c0fdd1904086d21a1"
    client = Client(account_sid, auth_token)
    message = client.messages.create( body=send_message, from_='whatsapp:+14155238886', to='whatsapp:+918637282102 ' )
